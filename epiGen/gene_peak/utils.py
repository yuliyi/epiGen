...
def parse_args():
    ...
    parser.add_argument('--data_dir', nargs='?', default='/path/data',
                        help='Input data path.')
    parser.add_argument('--save_dir', nargs='?', default='/path',
                        help='save_model.')
    ...
    parser.add_argument('--mod', type=str, default='training', help='training or testing')
    parser.add_argument('-n', '--nodes', default=1, type=int, metavar='N')
    parser.add_argument('-g', '--gpus', default=8, type=int, help='number of gpus per node')
    parser.add_argument('-nr', '--nr', default=3, type=int, help='ranking within the nodes')
    ...
    if permutation:
        ...
        for group_name in np.unique(group_col):
            ...
            if len(group_indices) > 0:
                ...
                rna_test_mat[group_indices, gene_ensembl].X = shuffled_data
    else:
