...
def main(args, ct, chr, device=None):
    ...
    atac_delta_adata.write_h5ad(data_dir + f"/perturbation_tumor/gene_peak_regulation/atac_delta_tumor_normal_{ct}_{gene_name}_{chr}.h5ad", compression='gzip')
...
if __name__ == '__main__':
    ...
    if not os.path.exists(f"{args.data_dir}/perturbation_tumor/gene_peak_regulation/atac_delta_tumor_normal_{ct}_{gene_name}_{gene_chrom}.h5ad"):
        main(args, ct, gene_chrom, device)