...
def get_close_peaks_effect(atac_delta_adata: ad.AnnData, peaks_df: pd.DataFrame, gene_ranges_df: pd.DataFrame, perturbed_gene: str, perturbed_gene_name: str, chr: str, prefix: str) -> None:
    '''
...
rna_list = ad.read_h5ad(args.data_dir + f"/rna_data/rna_independence.h5ad")
...
for chr in chrom_list:
    ...
    for i, g in enumerate(all_perturb_genes):
        ...
        get_close_peaks_effect(atac_delta_adata, peaks_df, gene_ranges_df, g, g_name, chr, prefix)
        del model_g
        torch.cuda.empty_cache()