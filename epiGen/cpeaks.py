...
if __name__ == "__main__":
    ...
    parser.add_argument("--reference_path", '-cpeaks',type=str, default=None,help="path to reference file")
    ...
    if reference == 'hg38':
        cpeaks_path = f'{args.reference_path}/cpeaks_hg38.bed.gz'
    else:
        raise ValueError('reference must be hg38')
